...
const Create = () => {
  ...
  const [adminDOB, setAdminDOB] = useState( moment().format("YYYY-MM-DD")  || "");
...
const adminDOBChange = (e) => {
    ...
    if (age < 18) {
        setError(prev => [...prev, "Date of birth must be at least 18 years old."]);
    }
}
  ...
  const handleSubmit = async (e) => {
    ...
    const msgTitle = 'New Admin Data Confirmation ';
    const msgBody = [ 
    ...
    <>
      <CRow>
        <CCol xs="12">
          ...
          <CCard>
            <CCardHeader>
              <h4 className='m-0'>Admin Account Registeration</h4>
            </CCardHeader>
            <CCardBody>
              <CRow>
                <CCol lg="6" className="">
